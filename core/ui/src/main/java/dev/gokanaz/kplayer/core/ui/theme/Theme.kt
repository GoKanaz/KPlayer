...
val LocalAppThemeConfig = staticCompositionLocalOf {
    AppThemeConfig()
}
...
fun AppTheme(
    ...
    val useDarkTheme = when (themeConfig.darkMode) {
    ...
    val colorScheme = when {
        themeConfig.dynamicColorEnabled && Build.VERSION.SDK_INT >= Build.VERSION_CODES.S -> {
    ...
    CompositionLocalProvider(
        LocalAppThemeConfig provides themeConfig
    ) {
        MaterialTheme(
